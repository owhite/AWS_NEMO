...
s3://nemo-public-preview.s3.us-east-1.amazonaws.com
...
This document provides the entire NeMO human and mammalian brain atlas along with listed sequence directories. Caution, this file is 58M: nemo_public_tree_full.txt

The nemo_public_tree_full.txt does NOT include the sequence files themselves, it simply lists the directories that contain those files. The file formats used in the sequence directories are described here: 

https://github.com/nemoarchive/documentation/blob/master/file_extensions.md
